...
public class Gerente {
    ...
    public void setGerente(Usuario gerente) {
        if (gerente == null) throw new IllegalArgumentException("Gerente inválido");
        this.usergerente = gerente;
    }

    public Usuario getGerente() { return usergerente; }

    public void cadastrarAutor(Autor autor, SystemSearch sistema) {
        if (autor == null) throw new IllegalArgumentException("Autor inválido");
        sistema.cadastrarAutor(autor);
    }

    public void cadastrarAvaliador(Avaliador avaliador, SystemSearch sistema) {
        if (avaliador == null) throw new IllegalArgumentException("Avaliador inválido");
    ...
    public void excluirAvaliador(String nomeAvaliador, SystemSearch sistema) {
        ...
        if (avaliador == null) throw new IllegalArgumentException("Avaliador não encontrado");
    ...
    public void listarAutores(SystemSearch sistema) { sistema.listarAutores(); }
    public void listarAvaliadores(SystemSearch sistema) { sistema.listarAvaliadores(); }
    public void listarObras(SystemSearch sistema) { sistema.listarTodasObras(); }
    public void buscarObraPorTitulo(String titulo, SystemSearch sistema) { sistema.buscarObraPorTitulo(titulo); }
    public void buscarObraPorAutor(String nomeAutor, SystemSearch sistema) { sistema.buscarObrasPorAutor(nomeAutor); }
    public void exibirGerente() { usergerente.exibirDados(); }
}
