...
public class ObraDAO {
    ...
    private String sqlBase() {
        return "SELECT o.id, o.titulo, o.genero, o.ano, o.status, o.data_avaliacao, "
             + "u.cpf AS cpf_autor, u.nome AS nome_autor, u.endereco AS end_autor, u.senha_hash AS hash_autor, "
             + "av.cpf_usuario AS cpf_avaliador, uav.nome AS nome_avaliador, uav.endereco AS end_avaliador, uav.senha_hash AS hash_avaliador "
             + "FROM obra o "
    ...
    public Obra construirObra(ResultSet rs) throws SQLException {
        String hashAutor = rs.getString("hash_autor");
        Usuario usuAutor = new Usuario(rs.getString("cpf_autor"), rs.getString("nome_autor"), rs.getString("end_autor"), hashAutor != null ? hashAutor : "");
        ...
        if (cpfAval != null) {
            ...
            String hashAval  = rs.getString("hash_avaliador");
            if (nomeAval != null) {
                Usuario usuAval = new Usuario(cpfAval, nomeAval, endAval != null ? endAval : "", hashAval != null ? hashAval : "");
